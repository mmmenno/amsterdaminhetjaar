...
;(function ( $, window, document, undefined ) {
	...
	function Plugin(element, options) {
		...
		function _fixBlockSizes() {
			var timeBlockSize = $el.css('padding-top').replace('px', '') * 1;
		...
		function _createDots() {
			children.each(function( index ) {
				...
				var dotHtml = '<a href="#' + year + '" class="' + options.className + '-dot"><span ' + 'class="' + options.className + '-dot-text" data-year="' + year + '" data-text="' + text + '"></span></a>';
